...
<div style="flex:1;max-width:620px;">
  ...
  <section>
    <h1 class="hero-title">
      Contributing to research in intestinal failure and transplantation
    </h1>

    <p class="hero-sub">
      A highly specialized scientific meeting bringing together leading experts to address some of the most complex challenges in gastrointestinal and transplant medicine.
    </p>

    <div class="conf-meta">Gothenburg, Sweden</div>
