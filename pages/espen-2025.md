...
.translate-btn {
  ...
  font-size: 0.72rem; color: var(--color-base-text-2);
  cursor: pointer; margin-left: 0.4rem; opacity: 0.6; vertical-align: middle;
}
.translate-btn:hover { opacity: 1; }
.translate-btn:hover .translate-label { text-decoration: underline; }
.li-translation {
  display: none; margin-top: 0.4rem; padding: 0.4rem 0.6rem;
  background: var(--color-base-bg-3); border-radius: 6px;
  font-size: 0.8rem; color: var(--color-base-text-2);
  font-style: italic; border-left: 2px solid var(--color-base-text-2); opacity: 0.8;
}
</style>

<script>
function toggleTranslation(btn, targetEl) {
  if (targetEl.style.display === "block") {
    targetEl.style.display = "none";
    btn.querySelector(".translate-label").textContent = "Translate";
  } else {
    targetEl.style.display = "block";
    btn.querySelector(".translate-label").textContent = "Hide";
  }
}
</script>
...
<div class="li-card">
  ...
  <div class="li-body">
    <p>Many thanks to ESPEN - European Society for Clinical Nutrition and Metabolism for the opportunity to present our work in the Best Abstracts session, and for awarding the Young Investigators under 35 travel grant.</p>
    <p>Nine days later, I returned still inspired by stellar presentations, especially Prof. Lubos Sobotka's lecture, which elegantly connected the origins of Life to the mechanisms of insulin resistance.</p>
    <p>Deep respect to exceptional teams from Belgium, Italy, and the Czech Republic. Gratitude to all scientists and dietitians for sharing your insightful experiences — your dedication makes science real.</p>
    <p>Eager to publish soon, for patients above all, and to honor the invaluable work of Prof. Francisca Joly over 20 years. Thank you <span class="li-tag">#ESPEN2025</span> 🇨🇿</p>
  </div>
  <img class="li-photo" src="/assets/images/espen-2025.jpg" alt="ESPEN 2025 — Prague">
  <div class="li-footer">
    <div class="li-stat">👍 40</div>
    <div class="li-stat">💬 6 &nbsp;·&nbsp; 2 reposts</div>
    <a class="li-link" href="https://www.linkedin.com/posts/minh-chau-ta_espen2025-ugcPost-7376400136786296832-TCE4" target="_blank">View on LinkedIn ↗</a>
  </div>
  <div class="li-comments">

    <div class="li-comment">
      <div class="li-comment-avatar">CB</div>
      <div class="li-comment-body">
        <div class="li-comment-name">Cécile Betry</div>
        <div class="li-comment-title">M.D. PhD — Nutrition Specialist</div>
        Félicitations Minh Chau Ta pour l'excellente présentation et les perspectives inspirantes de ce travail pour les patients
        <span class="translate-btn" onclick="toggleTranslation(this, this.nextElementSibling)">🌐 <span class="translate-label">Translate</span></span>
        <div class="li-translation">Congratulations Minh Chau Ta for the excellent presentation and the inspiring perspectives of this work for patients</div>
      </div>
    </div>

    <div class="li-comment">
      <div class="li-comment-avatar">FJ</div>
      <div class="li-comment-body">
        <div class="li-comment-name">Francisca Joly</div>
        <div class="li-comment-title">Professor of Nutrition, Gastroenterologist</div>
        Thanks my dear Min Chau. You are the best
      </div>
    </div>
...
<div class="conf-sidebar-sticky" style="width:260px;flex-shrink:0;position:sticky;top:2rem;align-self:flex-start;">
  <fieldset style="border:1px dashed rgba(44,36,22,0.25);border-radius:6px;padding:0.75rem 1rem;margin-bottom:1.25rem;font-family:inherit;">
    ...
    <ul style="list-style:none;padding:0;margin:0;display:flex;flex-direction:column;gap:0.35rem;">
      ...
      <li style="font-size:0.75em;opacity:0.4;font-weight:600;white-space:nowrap;">— ESPEN <span style="font-weight:400;">Prague, Czech Republic</span></li>
