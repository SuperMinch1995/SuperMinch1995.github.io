...
<!-- ══════════════════════════════════════════════════
     REVEAL TARGET — everything below the arrow
═══════════════════════════════════════════════════ -->
...
(function () {
  window.addEventListener('message', function (e) {
    ...
    var h = Math.min(Math.max(e.data.q247pHeight, 400), 6000);
...
(function () {
  window.addEventListener('message', function (e) {
    ...
    if (!iframe || e.source !== iframe.contentWindow) return;
    var h = Math.min(Math.max(e.data.sunburstHeight, 400), 6000);
    iframe.style.height = h + 'px';
  });
})();
</script>
...
(function () {
  ...
  /* Fallback si le postMessage est manqué */
